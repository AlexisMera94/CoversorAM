...
public class MainActivityAM extends AppCompatActivity {
    ...
    public void clickConvertit(View v){
        ...
        if (resultado>0){
            ...
            Toast.makeText(MainActivityAM.this, "Las opciones elegidas no tienen un factor de conversión", Toast.LENGTH_SHORT).show();
